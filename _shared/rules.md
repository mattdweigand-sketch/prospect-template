...
- With policy.mode set to example, customer research and outreach use synthetic local inputs only; do not query or modify live CRM/mail/warehouse providers. prospect-setup may read explicitly supplied messaging materials or the named knowledge source to prepare configuration. Live operating workflows require their adapters and policy to be configured and reviewed.
